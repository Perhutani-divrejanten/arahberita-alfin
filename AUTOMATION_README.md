...
- **socialHandle**: Handle social media (akan replace "arahberita")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #166534 → custom)
...
| `arahberita` | `siteName` (tanpa spaces) |
| `arahberita` | `socialHandle` |
