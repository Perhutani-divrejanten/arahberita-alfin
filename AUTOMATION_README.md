...
- **siteName**: Nama portal berita (akan replace "Fokus Janten")
- **email**: Email portal (akan replace "fokusjanten@gmail.com")
...
2. Untuk setiap dari 34 site:
   - Copy folder **Fokus Janten** → folder baru
